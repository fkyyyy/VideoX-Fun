    ...
    def forward(
        ...
        if e.dim() > 3:
            ...
            shift_mvs, scale_mvs, gate_mvs = (
                self.modulation_mvs.to(dtype=x.dtype, device=x.device) + e[:, :3, :]).chunk(3, dim=1)       
        ...
        # h,w = 32, 72 # h, w hard code for inpainting
        ...
        x = x + gate_mvs * self.projector(self.mvs_attn(input_x, seq_lens, grid_sizes, freqs, dtype, t=t))
